...
sim_sis = ss.Sim(
    n_agents=1_000,
    networks=ss.RandomNet(n_contacts=10),
    diseases=ss.SIS(beta=0.05, dur_inf=4, init_prev=0.01),
    dt=1.0, start=0, stop=200, rand_seed=42, verbose=0,
)
sim_sis.run()
...
sim_seir = ss.Sim(
    n_agents=1_000,
    networks=ss.RandomNet(n_contacts=10),
    diseases=SEIR(beta=0.05, dur_exp=2, dur_inf=4, init_prev=0.01),
    dt=1.0, start=0, stop=200, rand_seed=42, verbose=0,
)
sim_seir.run()
...
for b in betas:
    sim = ss.Sim(
        n_agents=1_000, networks=ss.RandomNet(n_contacts=10),
...
sim_multi = ss.Sim(
    ...
    diseases=[
        ...
        ss.SIS(name='cold', beta=0.05, dur_inf=3, init_prev=0.02),
    ],
    dt=1.0, start=0, stop=200, rand_seed=42, verbose=0,
)
sim_multi.run()
