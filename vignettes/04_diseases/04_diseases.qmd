...
sim_seir = Sim(
    n_agents = 1_000,
    networks = RandomNet(n_contacts=10),
    diseases = SEIR(beta=0.05, dur_exp=2.0, dur_inf=4.0, init_prev=0.01),
    dt = 1.0,
    stop = 200.0,
    rand_seed = 42,
    verbose = 0,
...
for d in durations
    sim = Sim(
        n_agents=1_000, networks=RandomNet(n_contacts=10),
        diseases=SIR(beta=0.05, dur_inf=d, init_prev=0.01),
        dt=1.0, stop=200.0, rand_seed=42, verbose=0,
    )
    run!(sim)
    prev = get_result(sim, :sir, :prevalence)
...
sim_lethal = Sim(
    n_agents = 1_000,
    networks = RandomNet(n_contacts=10),
    diseases = SIR(beta=0.05, dur_inf=4.0, init_prev=0.01, p_death=0.02),
    dt = 1.0,
    stop = 200.0,
    rand_seed = 42,
    verbose = 0,
