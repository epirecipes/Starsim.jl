...
sim_base = ss.Sim(
    ...
    dt=1.0, start=0, stop=365*2, rand_seed=42, verbose=0,
)
sim_base.run()
...
sim_sis_base = ss.Sim(
    ...
    dt=1.0, start=0, stop=365*3, rand_seed=42, verbose=0,
)
sim_sis_base.run()
...
sim_multi = ss.Sim(
    ...
    networks=ss.RandomNet(n_contacts=10),
    diseases=[
        ss.SIS(name='flu', beta=0.05, dur_inf=3, init_prev=0.01),
